...
from sysdate_to_current_timestamp import sysdate_to_current_timestamp
...
class TestOracleToPostgresDateConversion(unittest.TestCase):
    ...
    # def test_multiple_sysdate(self):
    #     oracle_sql = """SELECT SYSDATE as now, 
    #                    SYSDATE - INTERVAL '1' DAY as yesterday 
    #                    FROM dual;"""
    #     expected = """SELECT CURRENT_TIMESTAMP as now, 
